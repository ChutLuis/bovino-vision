...
| RNF-02 | Tiempo de inferencia aceptable en gama media | ≤ 3 s por foto. **No se cumple con originales de 12 MP**: en la compilación de entrega medida en el Galaxy A25 (19 de septiembre de 2026, seis fotografías de la campaña, cinco repeticiones por caso) la mediana fue de 25.5–29.1 s por fotografía aceptada y de 13.2–16.0 s por rechazo sin animal; la decodificación JPEG (≈ 55 %) y ArUco a resolución completa (≈ 40 %) dominan y la inferencia es ≈ 0.55 s (`informes/benchmark_release_a25_20260919/`). Con fotografías de 1280×960 (agosto de 2026, 10 fotos del piloto) el flujo tarda ≈ 2.0 s (segmentación 0.45 s + ArUco 1.4 s + postproceso 0.15 s; `informes/benchmark_a25_20260826_fullres.json`). Arranque en frío 3.97 s, mitigado con precarga al abrir la app. Vías de optimización identificadas, no aplicadas: submuestrear la imagen antes de detectar el marcador y sacar la decodificación JPEG de JavaScript |
